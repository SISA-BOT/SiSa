...
\033[1;91m███████║██║███████║██║  ██║
╚══════╝╚═╝╚══════╝╚═╝  ╚═╝
\x1b[38;5;196m╔═════════════╗  ࿇⃝🌹⃢I🌹⃝࿇  \033[38;5;46m╔════════════════════╗
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐀𝐔𝐓𝐇𝐎𝐑   ║  ࿇⃝🌹⃢T🌹⃝࿇  \033[38;5;46m║\033[38;5;46mSISA              ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 ║  ࿇⃝🌹⃢Z🌹⃝࿇  \033[38;5;46m║\033[38;5;46mSiSa║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 ║  ࿇⃝🌹⃢S🌹⃝࿇  \033[38;5;46m║\033[38;5;46m8801838711989       ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐆𝐈𝐓𝐇𝐔𝐁   ║  ࿇⃝🌹⃢I🌹⃝࿇  \033[38;5;46m║\033[38;5;46SISA-BOT   ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌 ║  ࿇⃝🌹⃢S🌹⃝࿇  \033[38;5;46m║\033[38;5;46@sisagaming45        ║
\033[38;5;46m║[🔵]\x1b[38;5;196mWORKS    ║  ࿇⃝🌹⃢A🌹⃝࿇ \033[38;5;46m║\033[38;5;46mData & Wifi         ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐅𝐑𝐎𝐌     ║  ࿇⃝🌹⃢BA🌹⃝࿇\033[38;5;46m ║\033[38;5;46m𝐁𝐀𝐍𝐆𝐋𝐀𝐃𝐄𝐒𝐇          ║
\x1b[38;5;196m╚═════════════╝  ࿇⃝🌹⃢BY🌹⃝࿇  \033[38;5;46m╚════════════════════╝
""")
...
rp= 'CYBER'
x = 'ARAFAT'
if 'SiSa'==user and 'Bot'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL FOLLOW MY FACEBOOK ACCOUNT")
	os.system('https:m.facebook.com/SiSaGaming45')
else:
	Axak(y+"\n\n\t\t      Invalid User Or Pass")
	Axak(y+"\n\n\t\tContract Admin For User And Pass")
	os.system("xdg-open wa.me/+8801838711989")
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH SISA-BOT ;) {w}<{r}/{w}>\n\n")
...
os.system("xdg-open https://wa.me/+8801838711989")
print (logo)
print(f"""\n{ran}\033[1;31m                                                               
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥SiSa🔥 "+w+tim)
	...
	input(g+"\n\t\t\tPROCCES DONE NOW ENTER FOR CONTINUE")
	os.system("clear")
	os.system("python S-BOOMB.py")
